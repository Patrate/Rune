...
public class ModRecipeProvider extends RecipeProvider {
	...
	protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(ModItems.WOODEN_WAND.getItem()).define('#', Items.STICK).define('X', ItemTags.PLANKS)
				.pattern("#").pattern("X").pattern("#").unlockedBy("has_stick", has(Items.STICK)).save(consumer);
		ShapedRecipeBuilder.shaped(ModItems.STONE_WAND.getItem()).define('#', Items.STICK)
		...
		ShapedRecipeBuilder.shaped(ModItems.IRON_WAND.getItem()).define('#', Items.STICK).define('X', Items.IRON_INGOT)
				.pattern("#").pattern("X").pattern("#").unlockedBy("has_iron_ingot", has(Items.IRON_INGOT))
				.save(consumer);
		ShapedRecipeBuilder.shaped(ModItems.GOLDEN_WAND.getItem()).define('#', Items.STICK)
				.define('X', Items.GOLD_INGOT).pattern("#").pattern("X").pattern("#")
				.unlockedBy("has_gold_ingot", has(Items.GOLD_INGOT)).save(consumer);
		ShapedRecipeBuilder.shaped(ModItems.DIAMOND_WAND.getItem()).define('#', Items.STICK).define('X', Items.DIAMOND)
				.pattern("#").pattern("X").pattern("#").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer);
		ShapedRecipeBuilder.shaped(ModItems.NETHERITE_WAND.getItem()).define('#', Items.STICK)
		...
		netheriteSmithing(consumer, ModItems.DIAMOND_WAND.getItem(), ModItems.NETHERITE_WAND.getItem());
