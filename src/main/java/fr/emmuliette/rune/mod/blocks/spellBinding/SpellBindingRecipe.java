...
public class SpellBindingRecipe implements IRecipe<SpellBindingInventory> {
	...
	public SpellBindingRecipe(ResourceLocation p_i48162_1_, String p_i48162_2_, int p_i48162_3_, int p_i48162_4_,
	...
	public boolean matches(SpellBindingInventory p_77569_1_, World p_77569_2_) {
	...
	private boolean matches(SpellBindingInventory p_77573_1_, int p_77573_2_, int p_77573_3_, boolean p_77573_4_) {
	...
	public ItemStack assemble(SpellBindingInventory p_77572_1_) {
	...
	private static NonNullList<Ingredient> dissolvePattern(String[] p_192402_0_, Map<String, Ingredient> p_192402_1_,
