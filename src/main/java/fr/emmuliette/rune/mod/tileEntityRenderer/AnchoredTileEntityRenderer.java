...
public class AnchoredTileEntityRenderer extends TileEntityRenderer<AnchoredTileEntity> {

	public AnchoredTileEntityRenderer(TileEntityRendererDispatcher dispatcher) {
		super(dispatcher);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(AnchoredTileEntity te, float partialTicks, MatrixStack mStack, IRenderTypeBuffer buffer,
			int light, int overlay) {
		if(te.getOldBlockId() == null)
			return;
		BlockState blockstate = Block.stateById(te.getOldBlockId());
