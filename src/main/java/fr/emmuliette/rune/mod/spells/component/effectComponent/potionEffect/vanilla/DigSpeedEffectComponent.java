...
public class DigSpeedEffectComponent extends PotionEffectComponent {

	public DigSpeedEffectComponent(AbstractSpellComponent parent) {
		super(parent, Effects.DIG_SPEED);
	}
