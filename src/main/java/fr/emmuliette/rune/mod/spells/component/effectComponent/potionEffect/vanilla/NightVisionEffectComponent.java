...
public class NightVisionEffectComponent extends PotionEffectComponent {

	public NightVisionEffectComponent(AbstractSpellComponent parent) {
		super(parent, Effects.NIGHT_VISION);
	}
